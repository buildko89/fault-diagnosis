...
def _transfer_impedance(circuit: Circuit, Y_nom: sp.spmatrix,
...
def _sample_measured_values(circuit: Circuit,
...
def calculate_measurements(circuit: Circuit, excitations: List[np.ndarray],
...
def calculate_delta_v(circuit: Circuit, excitations: List[np.ndarray],
                      faulty_elements: Optional[Dict[str, float]] = None,
                      rng: Optional[np.random.Generator] = None,
